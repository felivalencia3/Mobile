...
export default class AlertScreen extends Component {
    ...
    componentWillMount() {
        /// Configure how audio will play in our app!
        /// Learn more here: https://docs.expo.io/versions/latest/sdk/audio
    ...
    componentDidMount() {
        this.interval = setInterval(() => {this.updateDistance();this.updateCoords();this.checkDistance()}, 1000);
    }
    checkDistance() {
        const DURATION = 1000;
